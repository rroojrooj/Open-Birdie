...
| Candidate commit | First code candidate `61d9ab78edd1f56e361b7884d203d832483a6c65` was rejected; corrected code evidence `5d13c1c5ba8de2628dd294f24bcf5a589065407e`; documentation is a code-identical descendant |
| Pull request / merge commit | Pending independent acceptance |
| Focused tests | Five required commands pass 124/124: identity/cache 14, HD 44, schema/staging/presentation 31, package/activation/race 21, asset HTTP/package 14 |
| Full test count | `npm test`: 487 passed, 0 failed, 0 cancelled, 0 skipped |
| Identity/cache migration evidence | Stable node/way/relation IDs, 250 m legacy verification, atomic non-destructive migration, collision isolation, nested/top-level identity agreement, same-ID acquisition coalescing, native different-ID abort, cross-process publication locking/late-winner recheck, coherent asset set with JSON last, and exact embedded identity pass. Stable-source legacy v3 activation regression is covered; source-less activation remains rejected. |
...
| Asset HTTP/package-root evidence | GET/HEAD/ETag/304, same-inode/same-size mutation-window ownership, one-read asset preparation, TOCTOU/hash/file-identity tests pass; `npm run pack` passes; staged and unpacked packaged smoke report `{"status":"valid","packCount":1}`; 912-entry asar scan has zero Ajv/esbuild/source-schema/authoring-root matches. |
...
| Independent review | Pass 1 exact code `61d9ab7` / documentation `c7520a3`: REJECT 97%, 0 Critical, 3 High, 6 Medium, 0 Low. All nine are corrected; exact `5d13c1c` awaits pass-2 review. |
