...
const { inspectRuntimeAsset, loadRuntimeCourseArt } = require('./course-art-assets');
...
function hdDiagnostic(result, courseId) {
  ...
  const code = result.code === 'HD_FINGERPRINT_VERSION_UNSUPPORTED'
    ? result.code
    : 'HD_BUNDLE_REJECTED';
