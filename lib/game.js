...
class Game {
  ...
  setCourse(course, { terrainPatches = [], ready = true } = {}) {
    ...
    this.terrain = course.elevation
      ? makeTerrain(course.elevation, [...terrainPatches, ...(course.elevation.patches || [])], { smooth: true })
      : flatTerrain();
  ...
  activateRuntimeTerrain(terrainPatches = []) {
    ...
    this.terrain = this.course.elevation
      ? makeTerrain(this.course.elevation, [...terrainPatches, ...(this.course.elevation.patches || [])], { smooth: true })
      : flatTerrain();
